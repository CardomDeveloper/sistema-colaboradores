    ...
    <>
        ...
        <div className="bg-white shadow-md rounded-md mt-10 px-5 py-10">
            <form action="">
                ...
                <input className="bg-indigo-600 hover:bg-indigo-800 text-white w-full mt-5 p-3 uppercase font-bold cursor-pointer" type="submit" value="Iniciar Sesión" />
            </form>
        </div>

        <nav className="mt-5">
            <Link to="/auth/registro" className="text-blue-400">¿No tienes cuenta? Crea una</Link>
        </nav>
    </>
  )
}
